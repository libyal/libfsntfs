...
LIBRARY_TESTS="attribute bitmap_values cluster_block compressed_block_descriptor data_run data_stream directory directory_entry error file_entry file_name_values index index_entry index_node index_value io_handle logged_utility_stream_values mft mft_entry notify object_identifier_values reparse_point_values security_descriptor_index security_descriptor_index_value security_descriptor_values standard_information_values txf_data_values usn_change_journal volume_header volume_information_values volume_name_attribute volume_name_values";
