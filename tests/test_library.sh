...
LIBRARY_TESTS="attribute attribute_list attribute_list_entry bitmap_values buffer_data_handle cluster_block cluster_block_data_handle cluster_block_stream cluster_block_vector compressed_block compressed_block_data_handle compressed_block_vector compression compression_unit_data_handle compression_unit_descriptor data_run data_stream directory_entries_tree directory_entry error file_entry file_name_attribute file_name_values fixup_values index index_entry index_entry_header index_node index_node_header index_root_header index_value io_handle logged_utility_stream_values mft mft_attribute mft_entry mft_entry_header name notify object_identifier_values reparse_point_attribute reparse_point_values sds_index_value security_descriptor_index security_descriptor_index_value security_descriptor_values standard_information_values txf_data_values usn_change_journal volume_header volume_information_attribute volume_information_values volume_name_attribute volume_name_values";
