        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                has_directory_entries_index = (
                    fsntfs_file_entry.has_directory_entries_index()
                )
        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                base_record_file_reference = (
                    fsntfs_file_entry.get_base_record_file_reference()
                )
        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                journal_sequence_number = (
                    fsntfs_file_entry.get_journal_sequence_number()
                )
        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                entry_modification_time = (
                    fsntfs_file_entry.get_entry_modification_time()
                )
        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                security_descriptor_data = (
                    fsntfs_file_entry.get_security_descriptor_data()
                )
        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                number_of_alternate_data_streams = (
                    fsntfs_file_entry.get_number_of_alternate_data_streams()
                )
        ...
        with DataRangeFileObject(test_source, test_offset or 0, None) as file_object:
            ...
            try:
                ...
                number_of_sub_file_entries = (
                    fsntfs_file_entry.get_number_of_sub_file_entries()
                )
