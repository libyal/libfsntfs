...
typedef struct fsntfstools_option fsntfstools_option_t;

struct fsntfstools_option
{
...
void fsntfstools_getopt_wrapped_fprint(
      FILE *stream,
...
void fsntfstools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fsntfstools_option_t *options,
      int number_of_options );

int fsntfstools_getopt_get_options_string(
     const fsntfstools_option_t *options,
     int number_of_options,
