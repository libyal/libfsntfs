         ...
         libcerror_error_t **error )
{
	...
	block_number         = data_handle->current_offset / data_handle->io_handle->cluster_block_size;
	cluster_block_offset = data_handle->current_offset % data_handle->io_handle->cluster_block_size;
	...
	while( segment_data_size > 0 )
	{
		     ...
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve cluster block: %" PRIu64 " from vector.",
			 function,
			 block_number );
		...
		if( cluster_block == NULL )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_VALUE_MISSING,
			 "%s: invalid cluster block: %" PRIu64 ".",
			 function,
			 block_number );
		...
		if( cluster_block->data == NULL )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_VALUE_MISSING,
			 "%s: invalid cluster block: %" PRIu64 " - missing data.",
			 function,
			 block_number );

			return( -1 );
		}
		if( cluster_block_offset >= cluster_block->data_size )
		{
			libcerror_error_set(
			 error,
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		     ...
		     read_size ) == NULL )
		{
			libcerror_error_set(
			 ...
			 "%s: unable to copy cluster block: %" PRIu64 " data.",
			 function,
			 block_number );
